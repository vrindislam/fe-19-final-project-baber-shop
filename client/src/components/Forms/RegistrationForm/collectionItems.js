export const collectionItemsForm = [
  { name: "firstName", label: "First Name", rules:[{required: true, message: 'Please enter your First Name!'}, {min: 2, message: 'Must be min 2 characters'}, {max: 24, message: 'Max 25 characters'}]},
  { name: "lastName", label: "Last Name", rules:[{required: true, message: 'Please enter your Last Name!'}, {min: 2, message: 'Must be min 2 characters'}, {max: 24, message: 'Max 25 characters'}]},
  { name: "login", label: "Login", rules: [{required: true, message: 'Please enter your Login'}, {min: 3, message: 'Must be min 2 characters'}, {max: 10, message: 'Max 10 characters'}]},
  ...
  { name: "password", label: "Password", rules: [{required: true, message: 'Please enter your password!'}, {min: 7, message: 'Must be min 7 characters'}, {max: 24, message: 'Max 25 characters'}]},
